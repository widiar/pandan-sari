			...
			<div class="row row-p	b-md">
				...
				<div class="col-md-4">
					<div class="gtco-widget">
						<h3>About Us</h3>
						<p>“PANDAN SARI Dive and Watersport” teregistrasi dibawah PT PANDAN SARI WISATA TIRTA. <br><br>Siap untuk mendampingi pelanggan dalam merencanakan dan mengorganisir Water Sport, All Events dalam koordinasi pada kebutuhan pelanggan dan biaya.</p>
					</div>
				</div>
